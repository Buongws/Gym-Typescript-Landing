...
const benefits: Array<BenefitType> = [
  ...
  },
  {
    ...
    title: "Expect Pro Trainers",
    description:
      "What's important is to get into shape and then not to have to worry about it. I don't want to get on stage and not be able to do something. Not being physically fit doesn't work for me",
  },
];
    ...
    <section id="benefits" className="mx-auto min-h-full w-5/6 py-20">
      ...
      >
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.5 }}
          variants={container}
          className="mt-5 gap-[30px] md:grid md:grid-cols-3 "
        >
          ...
          <div>
            ...
            <div className="relative">
              <div className="before:absolute before:-top-20 before:z-[1] before:content-abstractwaves">
                <div>
                  <HText>
                    MILION OF HAPPY MEMBERS GETTINGS{" "}
